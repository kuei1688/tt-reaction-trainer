...
>
> 核對基準：2026-07-06  
> 主要參考：`docs/CORE_FILE_SYNC_STATUS.md`、`docs/PHYSICS_MODEL_SPEC.md`、`AI_CONTEXT/DRAFTS/development_matrix_draft.md`
...
|---|---|---|---|---|---|---|
| 座標與單位規格 | 穩定 | 低 | `docs/physics-engine-v2-plan.md`, `docs/PHYSICS_MODEL_SPEC.md` | 文件審查 | GLM 整理 / Codex 審查 | 旋轉單位為 rad/s；細節仍以 Phase 0 原文為準 |
