...
function evaluateSharedCoreValues() {
  ...
  const names = [
    ...
    "SPIN3D_SCHEMA_VERSION", "MAGNUS_LIFT_SLOPE", "MAGNUS_COEFFICIENT", "physics3dCopySpin",
    "physics3dHasCanonicalSpin", "physics3dPhysicalSpinFromInput", "physics3dResolveOmega", "physics3dScaleSpin",
    "physics3dExposeSpin", "physics3dMagnusAcceleration", "physics3dAdvanceVelocity",
    "physics3dAdvanceSimulationVelocity", "physics3dSolvePlaneContact",
    "physics3dAdd", "physics3dSub", "physics3dScale", "physics3dDot", "physics3dNorm",
    "physics3dNormalize", "physics3dContactPointVelocity", "physics3dEffectiveMass",
    "physics3dApplyImpulse", "physics3dTangentBasis",
    "physics3dApplyCompliantContactImpulse",
    "physics3dCross",
    "dynamicEpsilon3D",
...
function loadGame4Physics(options = {}) {
  ...
  const runtimeExternals = {
    ...
    SPIN3D_SCHEMA_VERSION: sharedCoreValues.SPIN3D_SCHEMA_VERSION,
    MAGNUS_LIFT_SLOPE: sharedCoreValues.MAGNUS_LIFT_SLOPE,
    MAGNUS_COEFFICIENT: sharedCoreValues.MAGNUS_COEFFICIENT,
    physics3dCopySpin: sharedCoreValues.physics3dCopySpin,
    physics3dHasCanonicalSpin: sharedCoreValues.physics3dHasCanonicalSpin,
    physics3dPhysicalSpinFromInput: sharedCoreValues.physics3dPhysicalSpinFromInput,
    physics3dResolveOmega: sharedCoreValues.physics3dResolveOmega,
    physics3dScaleSpin: sharedCoreValues.physics3dScaleSpin,
    physics3dExposeSpin: sharedCoreValues.physics3dExposeSpin,
    physics3dMagnusAcceleration: sharedCoreValues.physics3dMagnusAcceleration,
    physics3dAdvanceVelocity: sharedCoreValues.physics3dAdvanceVelocity,
    physics3dAdvanceSimulationVelocity: sharedCoreValues.physics3dAdvanceSimulationVelocity,
    physics3dSolvePlaneContact: sharedCoreValues.physics3dSolvePlaneContact,
    physics3dAdd: sharedCoreValues.physics3dAdd,
    physics3dSub: sharedCoreValues.physics3dSub,
    physics3dScale: sharedCoreValues.physics3dScale,
    physics3dDot: sharedCoreValues.physics3dDot,
    physics3dNorm: sharedCoreValues.physics3dNorm,
    physics3dNormalize: sharedCoreValues.physics3dNormalize,
    physics3dContactPointVelocity: sharedCoreValues.physics3dContactPointVelocity,
    physics3dEffectiveMass: sharedCoreValues.physics3dEffectiveMass,
    physics3dApplyImpulse: sharedCoreValues.physics3dApplyImpulse,
    physics3dTangentBasis: sharedCoreValues.physics3dTangentBasis,
    physics3dApplyCompliantContactImpulse: sharedCoreValues.physics3dApplyCompliantContactImpulse,
    physics3dCross: sharedCoreValues.physics3dCross,
    dynamicEpsilon3D: sharedCoreValues.dynamicEpsilon3D,
    bounceWithSpinPhysical3D: sharedCoreValues.bounceWithSpinPhysical3D,
